...
<body>
	<header class="header-area center-center">
 ...
 -->
		<!-- Nav Area -->
		<div id="stickyNav-sticky-wrapper" class="sticky-wrapper center-center"
			style="height: 100px;">
			<div class="original-nav-area center-center" id="stickyNav" style="width: 2000px;">
						...
						<nav class="classy-navbar justify-content-between">
							...
							<div class="subscribe-btn">
								<a href="#" class="btn subscribe-btn" data-toggle=""
									data-target=""><img src="img/pickplace.png"></img></a>
							</div>
